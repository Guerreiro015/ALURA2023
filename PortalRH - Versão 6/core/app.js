...
function montarNotificacoes() {
  ...
  notificacoes.push({ tipo:'info', titulo:'THR Enterprise v6.0', texto:'Home executiva, Alertas RH e Processos com indicadores estão ativos.' });
  return notificacoes;
}
  ...
  box.innerHTML = `
    <div class="dossie-hero dossie-360-hero">
      ...
      <div class="dossie-main">
        <span class="enterprise-kicker">Dossiê 360° THR</span>
...
function obterUsuarios() {
  ...
  // v6.0: remove o perfil Consulta, migra o antigo Suporte e inclui Regional.
  usuarios = usuarios
