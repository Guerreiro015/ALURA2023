...
export const Router = {
  abrir(id){
    ...
    document.getElementById('auditView')?.classList.remove('active');
  ...
  relatorios(){
    ...
    document.getElementById('btnVoltarDashboard').classList.remove('d-none');
    document.querySelectorAll('.menu-item').forEach(b=>b.classList.toggle('active', b.id === 'menuRelatorios'));
    UI.setTitle('Relatórios','Indicadores e exportação das solicitações do Portal RH');
  },
  auditoria(){
    document.getElementById('dashboardView').classList.remove('active');
    document.getElementById('moduleView').classList.remove('active');
    ...
    document.getElementById('btnVoltarDashboard').classList.remove('d-none');
    document.querySelectorAll('.menu-item').forEach(b=>b.classList.toggle('active', b.id === 'menuAuditoria'));
    UI.setTitle('Auditoria','Logs de acesso e operações sensíveis do Portal RH');
  },
  configuracoes(){
    document.getElementById('dashboardView').classList.remove('active');
    document.getElementById('moduleView').classList.remove('active');
    ...
    document.getElementById('btnVoltarDashboard').classList.remove('d-none');
    document.querySelectorAll('.menu-item').forEach(b=>b.classList.toggle('active', b.id === 'menuConfig'));
    UI.setTitle('Configurações','Base local, histórico e usuário do sistema');
  },
  renderFormulario(m){
