export const MODULOS = [
  ...
  {
    id:'exclusao-sistemas', titulo:'Exclusão de Convênio Médico', categoria:'Benefícios / RH', icone:'fa-heart-pulse', cor:'roxa',
    descricao:'Solicitar exclusão de convênios médicos.',
    campos:[
      {id:'sistemas', label:'Sistemas a excluir', tipo:'textarea', obrigatorio:true},
      {id:'motivo', label:'Motivo', tipo:'select', opcoes:['Desligamento','Solicitação','Dependente +18','Outros'], obrigatorio:true}
    ]
  },
  {
    id:'crow-odonto', titulo:'Exclusão Convênio Odonto', categoria:'Benefícios', icone:'fa-tooth', cor:'ciano',
