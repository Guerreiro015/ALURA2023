...
argentina_dicio={'ano': argentina.index.tolist(),'imigrantes': argentina.values.tolist()} # tolist para criar a lista

print(argentina_dicio)

dados_argentina=pd.DataFrame(argentina_dicio)
...
fig.write_html('Gráfico_Plotly_animado.html')
# Mostrando a figura
fig.show()
