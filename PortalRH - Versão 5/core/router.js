...
export const Router = {
  ...
  dashboard() {
    ativarView('dashboardView', 'menuDashboard', 'Home', 'THR Enterprise • Visão executiva do RH');
  },

  historico() {
    ativarView('historyView', 'menuHistorico', 'Últimas Solicitações', 'Histórico geral de solicitações geradas no THR Enterprise');
  },

  relatorios() {
    ativarView('reportsView', 'menuRelatorios', 'Relatórios', 'Indicadores e exportação das solicitações do THR Enterprise');
  },

  auditoria() {
    ativarView('auditView', 'menuAuditoria', 'Auditoria', 'Logs de acesso e operações sensíveis do THR Enterprise');
  },

  timeline() {
    ativarView('timelineView', 'menuTimeline', 'Timeline do Colaborador', 'Histórico visual da vida do colaborador no THR Enterprise');
  },
  ...
  atividades() {
    ativarView('activityView', 'menuAtividades', 'Centro de Atividades', 'Feed operacional com as ações recentes do THR Enterprise');
  },
  ...
  novidades() {
    ativarView('updatesView', 'menuNovidades', 'Novidades da Versão', 'O que mudou no THR Enterprise v5.7');
  },
